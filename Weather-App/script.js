...
// function alternaBackground() {

//     var currentTime = new Date().getHours();
//     var div = document.getElementById("container-imagem");

//     if (currentTime >= 6 && currentTime <= 18) {

//         div.style.background = "url(img/ceu.jpg)"
...
function displayResults(weather) {
    ...
    low_high.innerText = `${Math.round(weather.main.temp_min)}°c Min/ ${Math.round(weather.main.temp_max)}°c Max`;
}
